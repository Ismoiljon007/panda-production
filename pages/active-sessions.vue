                    ...
                    <div class="active-sessions__bottom-wrapper">
                        <div class="active-sessions__items">
                            <div class="active-sessions__item">
                                <div class="active-sessions__item-img" v-if="sessions?.data?.current_session?.device_info?.includes('Mac OS')">
                                    <!DOCTYPE svg
                                ...
                                <div class="active-sessions__item-img" v-if="sessions?.data?.current_session?.device_info?.includes('iOS')">
                                    <!DOCTYPE svg
                                        PUBLIC '-//W3C//DTD SVG 1.1//EN' 'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'>
                                    <svg id="Capa_1" style="enable-background:new 0 0 90 90;" version="1.1"
                                        viewBox="0 0 90 90" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="active-sessions__item-img" v-if="sessions?.data?.current_session?.device_info?.includes('Windows')">
                                    <!DOCTYPE svg
                                        PUBLIC '-//W3C//DTD SVG 1.1//EN' 'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'>
                                ...
                                <div class="active-sessions__item-img" v-if="sessions?.data?.current_session?.device_info?.includes('Android')">
                                    <!DOCTYPE svg
                                        PUBLIC '-//W3C//DTD SVG 1.1//EN' 'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'>
                                ...
                                <div class="active-sessions__item-text-wrapper">
                                    <h3 class="active-sessions__item-title">{{ deiveName(sessions?.data?.current_session?.device_info) }}</h3>
                            ...
                            <div class="active-sessions__item" v-for="item in sessions?.data?.other_sessions" :key="item">
                                ...
                                <div class="active-sessions__item-text-wrapper">
                                    <h3 class="active-sessions__item-title">{{ deiveName(item?.device_info) }}</h3>
                                    <h4 class="active-sessions__item-date">
...
async function getSessions() {
    const data = await $fetch(store.authBase + '/auth/sessions?username=' + store.userInfo?.username, {
        headers: {
            'Authorization': 'Bearer ' + store.token
        }
    })
