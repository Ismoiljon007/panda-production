    ...
    <main>
        <!-- <div class="hero">
            ...
            <div class="container hero-container">
                <swiper @swiper="setThumbsSwiper" :spaceBetween="20" :slidesPerView="'auto'" :freeMode="true"
                    :watchSlidesProgress="true" :modules="modules" class="mySwiper">
                    <SwiperSlide v-for="item in banners?.data" :key="item">
                        <video-player class="hero__thumb-video" loop :poster="item?.thumbnail_image_url" muted
                            :autoplay="true" :src="item?.trailer_url" />
                        <span></span>
                    </SwiperSlide>
                </swiper>
            </div>
        ...
        <div class="hero">
            <Swiper :slides-per-view="'1'" :autoplay="{ delay: 10000, disableOnInteraction: false, }" :speed="800"
                ...
                <SwiperSlide v-for="item in banners?.data" :key="item" class="hero__slide">
                    <video-player loop muted playsinline
